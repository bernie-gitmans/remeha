...
function sample_data_dump($data_sample, $echo_flag, $newline)
	...
	$chsetpointhmi = $decode["67"];
	$dhwsetpointhmi = $decode["68"];
	...
	elseif ($lockout == 41) {$lockout = "Airbox temp max (Locking 41)";}
...
// START Display Sample Data as Captured
	...
	echo "chsetpointhmi: $chsetpointhmi$deg_symbol$newline";
	echo "dhwsetpointhmi: $dhwsetpointhmi$deg_symbol$newline";
	echo $newline;
...
//	echo "Hydro Pressure: $pressure"."bar$newline";
	...
	$chsetpointhmiIDX = $ini_array['chsetpointhmiIDX'];
	$dhwsetpointhmiIDX = $ini_array['dhwsetpointhmiIDX'];
...
//	$hruactive = $ini_array['hruIDX']; - need to add code for this
	...
	if ($DOMOUpdateAll == 1)
		...
		$DOMOchsetpointhmi = udevice($chsetpointhmiIDX, 0, $chsetpointhmi, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);
		$DOMOdhwsetpointhmi = udevice($dhwsetpointhmiIDX, 0, $dhwsetpointhmi, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);
...
//		$DOMOpressure = udevice($pressureIDX, 0, $pressure, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);
		...
		if ($DOMOdhwsetpoint_array != $dhwsetpoint) {$DOMOdhwsetpoint = udevice($dhwsetpointIDX, 0, $dhwsetpoint, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);}
				$DOMOchsetpointhmi_array = array_lookup($parsed_json, $chsetpointhmiIDX, $DOMOType);
		if ($DOMOchsetpointhmi_array != $chsetpointhmi) {$DOMOchsetpointhmi = udevice($chsetpointhmiIDX, 0, $chsetpointhmi, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);}
		$DOMOdhwsetpointhmi_array = array_lookup($parsed_json, $dhwsetpointhmiIDX, $DOMOType);
		if ($DOMOdhwsetpointhmi_array != $dhwsetpointhmi) {$DOMOdhwsetpointhmi = udevice($dhwsetpointhmiIDX, 0, $dhwsetpointhmi, $DOMOIPAddress, $DOMOPort, $Username, $Password, $DOMOUpdate);}
